...
function sendMail($email, $subject, $message) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'enriquezangela939@gmail.com';  // Your email
        $mail->Password = 'qfon qqti njaj jyjp';        // Your email password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Sender and recipient settings
        $mail->setFrom('enriquezangela939@gmail.com', 'Hi! any concern?');
